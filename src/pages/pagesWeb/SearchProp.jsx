...
const SearchProp = () => {
    ...
    return (
        <div className='p-3'>
            <div className='flex flex-col md:flex-row p-4 gap-2 bg-white'>
                ...
                <div className="inset-0 flex items-center justify-center sm:w-full">
