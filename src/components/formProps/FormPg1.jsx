                ...
                <div className=" font-urbanist">
                    ...
                    <div className=" flex justify-center text-white ">
                        <div className="font-normal flex flex-col sm:flex-row items-center justify-center p-2 bg-white">
                            ...
                            <div className='flex'>
                                <button className=" hover:bg-green1 hover:text-white text-gray-600 border border-gray-200 p-2 m-2 rounded w-full md:w-auto">
                                    Venta
                                </button>
                                <button className=" hover:bg-green1 hover:text-white text-gray-600 border border-gray-200 p-2 m-2 rounded w-full md:w-auto">
                                    Alquiler
                            ...
                            <div className="w-full">
                                ...
                                >
                                    <input
                                        type="text"
                                        id="Username"
                                        class="peer p-1 border-none bg-transparent placeholder-transparent focus:border-transparent focus:outline-none focus:ring-0 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-inset focus:ring-green1 sm:text-sm sm:leading-6"
                                        placeholder="Username"
                                    />
